      ...
      return (
        <div className="flex flex-col w-full sm:max-w-[450px] py-4 gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full">
            <a href={msg.data.linkedin} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5 bg-[#0077b5] text-white rounded-xl hover:bg-[#0077b5]/90 transition-colors shadow-sm font-medium text-[15px]">
            ...
            <a href={msg.data.github} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5 bg-[#24292e] text-white rounded-xl hover:bg-[#24292e]/90 transition-colors shadow-sm font-medium text-[15px]">
          ...
          <div className="bg-neutral-50 rounded-2xl p-4 sm:p-6 border border-neutral-200/60 mt-2">
            <form className="flex flex-col gap-4" onSubmit={(e: any) => {
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[12px] font-semibold text-neutral-500 uppercase tracking-wider ml-1">Your Name</label>
                <input type="text" placeholder="John Doe" className="bg-white border border-neutral-200/80 rounded-xl px-4 py-3 text-sm text-neutral-800 placeholder:text-neutral-400 focus:outline-none focus:border-neutral-400 transition-colors shadow-sm w-full min-w-0" required />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-[12px] font-semibold text-neutral-500 uppercase tracking-wider ml-1">Reply To</label>
                <input type="email" placeholder="you@example.com" className="bg-white border border-neutral-200/80 rounded-xl px-4 py-3 text-sm text-neutral-800 placeholder:text-neutral-400 focus:outline-none focus:border-neutral-400 transition-colors shadow-sm w-full min-w-0" required />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-[12px] font-semibold text-neutral-500 uppercase tracking-wider ml-1">Message</label>
                <textarea placeholder="Tell me about the role, the problem, or the idea..." rows={3} className="bg-white border border-neutral-200/80 rounded-xl px-4 py-3 text-sm text-neutral-800 placeholder:text-neutral-400 focus:outline-none focus:border-neutral-400 transition-colors resize-none shadow-sm w-full min-w-0" required></textarea>
              </div>
              <button type="submit" className="mt-2 w-full bg-neutral-900 text-white font-medium text-[15px] px-6 py-3.5 rounded-xl flex items-center justify-center gap-2 hover:bg-neutral-800 transition-colors active:scale-95 shadow-sm">
                Send Message
